...
"""
Tweede laag weg doen.
"""
"""		# initialize second set of CONV => RELU => POOL layers
		self.conv2 = Conv1d(in_channels=20, out_channels=40,
			kernel_size=5)
		self.relu2 = ReLU()
		self.maxpool2 = MaxPool1d(kernel_size=1, stride=1)
"""

#1 lineare laag beginnen.
"""
		# initialize first (and only) set of FC => RELU layers
		self.fc1 = Linear(in_features=192, out_features=100)
		self.relu3 = ReLU()
"""		# initialize our softmax classifier
		self.fc2 = Linear(in_features=100, out_features=1)
		self.logSoftmax = LogSoftmax(dim=1)

#Netwerk kleiner maken en dropout toevoegen.
